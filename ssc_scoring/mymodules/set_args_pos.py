...
parser.add_argument('--eval_id', help='id used for inference, or continue_train', type=int, default=277)
...
parser.add_argument('--workers',  help='number of workers for dataloader', type=int, default=8)
