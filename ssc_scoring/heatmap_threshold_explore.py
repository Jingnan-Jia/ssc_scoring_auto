...
ax_abs_all = fig_abs_all.add_subplot(1, 1, 1)
ax_abs_all.set_ylabel(f"Abs(highlighted ratio - Automatic scoring)")
ax_abs_all.set_xlabel(f"Threshold of highlighted area")
...
ax_abs_sum.set_ylabel(f"Abs(highlighted ratio - Automatic scoring)")
ax_abs_sum.set_xlabel(f"Threshold of highlighted area")
